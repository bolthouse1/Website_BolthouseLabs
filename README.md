...
2. Check [`PROJECT_STATE.md`](PROJECT_STATE.md) — the site is live and fully
   deployed; nothing is pending. It carries the W4.4 launch-flip procedure and
   the guardrails that outlive any one change.
